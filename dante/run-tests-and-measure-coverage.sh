...
function setTestSuitePath() {
    ...
    if [[ $technique_local == "atusa" ]]; then
        ...
        test_suite_path_local="$HOME/workspace/TREL26-Submission-Material-Testception/dante/applications/$application_name_local/testsuite-$application_name_local/src/main/java/tests/AtusaGeneratedTestSuite$element_strategy_local"K$k_local
    elif [[ $technique_local == "dante" || $technique_local == "crawljax" ]]; then
        test_suite_path_local="$HOME/workspace/TREL26-Submission-Material-Testception/dante/applications/$application_name_local/testsuite-$application_name_local/src/main/java/tests/GeneratedTestSuite$element_strategy_local"
    else
...
function setCoverageReportDirectoryPath() {
    ...
    local coverage_reports_directory_path_local="$HOME/workspace/TREL26-Submission-Material-Testception/dante/applications/$application_name_local/testsuite-$application_name_local/all-coverage-reports"
	if [[ $os == "Darwin" ]]; then
