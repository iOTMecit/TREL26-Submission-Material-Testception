...
function setTestSuitePath() {
    ...
    local test_suite_path_local="$HOME/workspace/TREL26-Submission-Material-Testception/dante/applications/$application_name_local/testsuite-$application_name_local/src/main/java/tests/GeneratedTestSuite$element_strategy_local.java"
	if [[ $os == "Darwin" ]]; then
