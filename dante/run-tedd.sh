...
function setDependencyGraphPath() {
    local application_name_local=$1
    local dependency_graph_path_local="$HOME/workspace/TREL26-Submission-Material-Testception/dante/applications/$application_name_local/testsuite-$application_name_local/src/main/resources"
	if [[ $os == "Darwin" ]]; then
